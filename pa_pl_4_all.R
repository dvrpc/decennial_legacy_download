...
# -----------------------------
header_file_path <- "G:\\Shared drives\\Data Coordination\\2020 Census\\2020 redistricting legacy format\\PA\\pageo2020.pl"
part1_file_path  <- "G:\\Shared drives\\Data Coordination\\2020 Census\\2020 redistricting legacy format\\PA\\pa000012020.pl"
part2_file_path  <- "G:\\Shared drives\\Data Coordination\\2020 Census\\2020 redistricting legacy format\\PA\\pa000022020.pl"
part3_file_path  <- "G:\\Shared drives\\Data Coordination\\2020 Census\\2020 redistricting legacy format\\PA\\pa000032020.pl"
...
# Order the data
# -----------------------------
combinePA <- combine[order(combine$LOGRECNO), c("FILEID", "STUSAB", "SUMLEV", "GEOVAR", "GEOCOMP", "CHARITER", "CIFSN", "LOGRECNO", "GEOID", 
                                              "GEOCODE", "REGION", "DIVISION", "STATE", "STATENS", "COUNTY", "COUNTYCC", "COUNTYNS", "COUSUB",
                                              "COUSUBCC", "COUSUBNS", "SUBMCD", "SUBMCDCC", "SUBMCDNS", "ESTATE", "ESTATECC", "ESTATENS", 
                                              "CONCIT", "CONCITCC", "CONCITNS", "PLACE", "PLACECC", "PLACENS", "TRACT", "BLKGRP", "BLOCK", 
                                              "AIANHH", "AIHHTLI", "AIANHHFP", "AIANHHCC", "AIANHHNS", "AITS", "AITSFP", "AITSCC", "AITSNS",
...
rownames(combinePA) <- 1:nrow(combinePA)
